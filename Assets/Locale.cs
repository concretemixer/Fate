...
public class Locale {
	...
	Dictionary<string, string> entries = new Dictionary<string,string> 
	{
        ...
        {"intro.girl_cash_ok", "- Спасибо, этого хватает."},
        ...
        {"intro.sec_look.0", "- Не работает. Кто-то испортил камеры, хе-хе!"},
        {"intro.sec_look.1", "- Не работает. Кто-то испортил камеры, хе-хе!"},
        ...
        {"intro.biker_talk.3", "- Курить на заправке - плохая идея, чувак!"},
		{"intro.biker_fuck_off", "- Отвали!"},
        {"intro.vending_cash","Это аппарат принимает только наличные"},
        {"intro.vending_cameras","Взломать эту штуку?\nТолько не под камерами!"},
        {"intro.vending_look","Автомат по продаже всякой фигни с двойной наценкой."},
        {"intro.vending_broken","Больше не работает. Сам постарался."},
	};
